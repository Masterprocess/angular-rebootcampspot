...
module.exports = "   \n<div class=\"col s12 m6\">\n  <div class=\"row\">\n    <div class=\"col s12\">\n    <a class=\"waves-effect waves-light btn-large\"><i class=\"material-icons left\">group_add</i>Add Students</a>\n    <a class=\"waves-effect waves-light btn-large\"><i class=\"material-icons left\">event</i>Add lessons</a>\n    <a class=\"waves-effect waves-light btn-large\"><i class=\"material-icons left\">account_balance</i>Add Cohorts</a>\n    <a class=\"waves-effect waves-light btn-large\"><i class=\"material-icons left\">border_color</i>Add Homeworks</a>\n  </div>\n  <div class=\"col s6\">6-columns (one-half)\n     \n          <div class=\"card horizontal\">\n            <div class=\"card-image\">\n              <img src=\"http://www.unc.edu/files/2012/06/ccm1_017934.jpg\">\n            </div>\n            <div class=\"card-stacked\">\n              <div class=\"card-content\">\n                  <ul>\n                      <li>\n                      <li class=\"waves-effect waves-light\"><a href=\"#!\"><i class=\"material-icons\">account_balance</i></a>UNC_MW Class</li>\n                      <li class=\"waves-effect waves-light\"><a href=\"#!\"><i class=\"material-icons\">account_balance</i></a>UNC_TTh Class</li>\n                    </ul>\n              </div>\n            </div>\n          </div>\n  </div>\n  <div class=\"col s6\">6-columns (one-half)\n  \n          <div class=\"card horizontal\">\n            <div class=\"card-image\">\n              <img src=\"https://2b79m75xexlhhf7411otxg15-wpengine.netdna-ssl.com/wp-content/uploads/2017/05/Video.jpg\">\n            </div>\n            <div class=\"card-stacked\">\n              <div class=\"card-content\">\n                  <a class=\"btn-flat waves-effect waves-light  \"><i class=\"material-icons left\">add_circle</i>Add Videos</a>\n              </div>\n           \n            </div>\n          </div>\n        \n  </div>\n</div>\n</div>\n\n<cohort-create>\n</cohort-create>\n\n<user-create>\n</user-create>\n\n\n<lesson-create>\n</lesson-create>\n\n<homework-create>\n</homework-create>\n\n\n<app-main-footer></app-main-footer>\n\n\n\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__check_in_check_in_component__ = __webpack_require__("../../../../../src/app/check-in/check-in.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__announcements_announcements_component__ = __webpack_require__("../../../../../src/app/announcements/announcements.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_33__check_in_check_in_component__["a" /* CheckInComponent */],
            __WEBPACK_IMPORTED_MODULE_34__announcements_announcements_component__["a" /* AnnouncementsComponent */],
...
module.exports = "<div>\n    <iframe width=\"100%\" height=\"500\" [src]=\"cohort.url | safe\" frameborder=\"0\" allowfullscreen>\n    </iframe>\n</div>\n<div>\n    <form>  \n        <h3 *ngIf=\"!editTitle\" (click)=\"onTitleClick()\">{{cohort.title}}</h3>     \n        <div *ngIf=\"editTitle\" class=\"form-group\">\n            <input type=\"input\" class=\"form-control\" name=\"title\" required placeholder=\"title\"\n            [(ngModel)]=\"cohort.title\">\n        </div>\n        <div class=\"form-group\">\n            <input type=\"input\" class=\"form-control\" name=\"url\" required placeholder=\"url\"\n            [(ngModel)]=\"cohort.url\">\n        </div>\n        <div class=\"form-group\">\n            <textarea class=\"form-control\" rows=\"5\" name=\"desc\" [(ngModel)]=\"cohort.description\">\n            </textarea>\n\t\t\t\t</div>\n\t\t\t\t<div style=\"margin-bottom: 50px;\"> \n        <button type=\"button\" (click)=\"updateCohort()\" class=\"btn btn-primary\">Update</button>  \n\t\t\t\t<button type=\"button\" (click)=\"deleteCohort()\" class=\"btn btn-danger\">Delete</button>\n\t\t\t\t</div>    \n    </form>\n</div>"
...
module.exports = "<div>\n    <iframe width=\"100%\" height=\"500\" [src]=\"homework.url | safe\" frameborder=\"0\" allowfullscreen>\n    </iframe>\n</div>\n<div>\n    <form>  \n        <h3 *ngIf=\"!editTitle\" (click)=\"onTitleClick()\">{{homework.title}}</h3>     \n        <div *ngIf=\"editTitle\" class=\"form-group\">\n            <input type=\"input\" class=\"form-control\" name=\"title\" required placeholder=\"title\"\n            [(ngModel)]=\"homework.title\">\n        </div>\n        <div class=\"form-group\">\n            <input type=\"input\" class=\"form-control\" name=\"url\" required placeholder=\"url\"\n            [(ngModel)]=\"homework.url\">\n        </div>\n        <div class=\"form-group\">\n            <textarea class=\"form-control\" rows=\"5\" name=\"desc\" [(ngModel)]=\"homework.description\">\n            </textarea>\n\t\t\t\t</div>\n\t\t\t\t<div style=\"margin-bottom: 50px;\"> \n        <button type=\"button\" (click)=\"updateHomework()\" class=\"btn btn-primary\">Update</button>  \n\t\t\t\t<button type=\"button\" (click)=\"deleteHomework()\" class=\"btn btn-danger\">Delete</button>\n\t\t\t\t</div>    \n    </form>\n</div>"
...
module.exports = "<div>\n    <iframe width=\"100%\" height=\"500\" [src]=\"lesson.url | safe\" frameborder=\"0\" allowfullscreen>\n    </iframe>\n</div>\n<div>\n    <form>  \n        <h3 *ngIf=\"!editTitle\" (click)=\"onTitleClick()\">{{lesson.title}}</h3>     \n        <div *ngIf=\"editTitle\" class=\"form-group\">\n            <input type=\"input\" class=\"form-control\" name=\"title\" required placeholder=\"title\"\n            [(ngModel)]=\"lesson.title\">\n        </div>\n        <div class=\"form-group\">\n            <input type=\"input\" class=\"form-control\" name=\"url\" required placeholder=\"url\"\n            [(ngModel)]=\"lesson.url\">\n        </div>\n        <div class=\"form-group\">\n            <textarea class=\"form-control\" rows=\"5\" name=\"desc\" [(ngModel)]=\"lesson.description\">\n            </textarea>\n\t\t\t\t</div>\n\t\t\t\t<div style=\"margin-bottom: 50px;\"> \n        <button type=\"button\" (click)=\"updateLesson()\" class=\"btn btn-primary\">Update</button>  \n\t\t\t\t<button type=\"button\" (click)=\"deleteLesson()\" class=\"btn btn-danger\">Delete</button>\n\t\t\t\t</div>    \n    </form>\n</div>"
...
module.exports = "<div>\n    <form>  \n        <h3 *ngIf=\"!editTitle\" (click)=\"onTitleClick()\">{{user.name}}</h3>     \n        <div *ngIf=\"editTitle\" class=\"form-group\">\n            <input type=\"input\" class=\"form-control\" name=\"name\" required placeholder=\"\"\n            [(ngModel)]=\"user.name\">\n        </div>\n        <div class=\"form-group\">\n            <input type=\"input\" class=\"form-control\" name=\"gmail\" required placeholder=\"devildude98@gmail.com\"\n            [(ngModel)]=\"user.gmail\">\n        </div>\n        <div class=\"form-group\">\n            <input type=\"input\" class=\"form-control\"  name=\"type\" required placeholder=\"student\" [(ngModel)]=\"user.type\">\n\t\t\t\t</div>\n\t\t\t\t<div style=\"margin-bottom: 50px;\"> \n        <button type=\"button\" (click)=\"updateUser()\" class=\"btn btn-primary\">Update</button>  \n\t\t\t\t<button type=\"button\" (click)=\"deleteUser()\" class=\"btn btn-danger\">Delete</button>\n\t\t\t\t</div>    \n    </form>\n</div>"
